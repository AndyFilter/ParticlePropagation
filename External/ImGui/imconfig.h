...
#define IM_VEC2_CLASS_EXTRA                                                                     \
        ...
        //constexpr float distance(const ImVec2 other) { return sqrtf(powf(x - other.x, 2) + powf(y - other.y, 2)); }
        //operator Vector2() { return Vector2; }
        //constexpr ImVec2(const Vector2& f) : x(f.x), y(f.y) {}                  \
        //operator Vector2() const { return Vector2(x,y); }

#define IM_VEC4_CLASS_EXTRA                                                     \
        constexpr ImVec4 operator * (const ImVec4 other) { return ImVec4(x*other.x, y*other.y, z*other.z, w*other.z); } \
